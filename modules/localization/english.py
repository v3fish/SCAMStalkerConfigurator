...
BUTTONS = {
    ...
    "remove_mouse_smoothing": "Disable Mouse Smoothing",
    "remove_water_slowdown": "Remove Water Slowdown",
    "remove_mouse_slowdown": "Remove Mouse Slowdown",
    "remove_camera_shake": "Remove Camera Shake",
    "remove_aim_block": "Remove Aim Block",
    "allow_overweight_movement": "Allow Overweight Movement",
    "language": "Language"
}
...
LABELS = {
    ...
    "disable_overweight_restriction_desc": "Removes the movement block to allow movement while overweight",
    "remove_water_slowdown_desc": "Removes movement slowdown while walking in water",
    "remove_mouse_slowdown_desc": "Removes mouse look slowdown (Water, grenades, anomalies, barbed wire, etc)",
    "remove_camera_shake_desc": "Removes all camera shake effects (Drunk, gunfire, mutants, etc)",
    "remove_aim_block_desc": "Removes the ADS block during concussion (grenades, etc.)"
}
